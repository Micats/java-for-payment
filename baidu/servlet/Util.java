...
public class Util {
	...
	public static String getSign(Map<String,String> signObject, String appSecret) {
		...
		for (int i = 0; i < keys.length; i++) {
			k = (String) keys[i];
			if(k.equals("appid")||k.equals("orderid")||k.equals("amount")||k.equals("unit")||k.equals("status")||k.equals("paychannel")) {
			...
			/*
			 * if (v.equals("0") || v.equals("")) { continue; }
			 */
			str += v;
		}
